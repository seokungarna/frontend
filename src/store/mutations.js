...
const mutations = {
  ...
  setStatusError(state, theError) {
    state.statuserror = theError;
  },
  setSecrets(state, theSecret) {
    state.secrets = theSecret;
  },
  clearUserData(state) {
    state.user = null;
    console.log(Vue.$cookies.get("laravel_session")); // return value         )
    console.log("hej");
